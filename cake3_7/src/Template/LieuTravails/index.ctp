    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h($lieuTravail->est_dans_liste) ?></td>
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $lieuTravail->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $lieuTravail->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $lieuTravail->id], ['confirm' => __('Are you sure you want to delete # {0}?', $lieuTravail->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
