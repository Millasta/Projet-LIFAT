 ...
 * @var \App\Model\Entity\EquipesResponsable $equipesResponsable
 */
...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $equipesResponsable->equipe_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $equipesResponsable->equipe_id)]
            )
        ?></li>
...
<div class="equipesResponsables form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Equipes Responsable') ?></legend>
        <?php
        ?>
    </fieldset>
