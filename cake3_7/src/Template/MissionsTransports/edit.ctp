 ...
 * @var \App\Model\Entity\MissionsTransport $missionsTransport
 */
?>
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $missionsTransport->mission_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $missionsTransport->mission_id)]
            )
        ?></li>
...
<div class="missionsTransports form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Missions Transport') ?></legend>
        <?php
        ?>
    </fieldset>
